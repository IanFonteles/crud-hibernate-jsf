...
public class TbCliente implements Serializable {
    ...
    public TbCliente(Integer idClient) {
        this.idClient = idClient;
    }

    public TbCliente(Integer idClient, String nmCliente, String cpfCliente, Date aniversarioCliente, String telefoneCliente, String dsEmail, String nmMaeCliente, String nmPaiCliente) {
        this.idClient = idClient;
